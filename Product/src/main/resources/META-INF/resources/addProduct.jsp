...
<link rel="stylesheet" type="text/css"
 ...
 <%
	...
	List<ProductFabric> listProductFabric = ProductFabricLocalServiceUtil.getProductFabrics(0,
			ProductColorLocalServiceUtil.getProductColorsCount());
			...
			<div class="jumbotron">
				...
				<form id="loginForm" method="post" action="${uploadImage}">
					...
					<div class="form-group">
							...
							name="selectProductMaterial">
							<option value="0" style="color: red">Please Add Material</option>
							<%
								for (int i = 0; i < listProductFabric.size(); i++) {
							%>
							<option value="<%=listProductFabric.get(i).getProductFabricId()%>"><%=listProductFabric.get(i).getProductFabricName()%></option>
							<%
								}
							%>
						</select>
